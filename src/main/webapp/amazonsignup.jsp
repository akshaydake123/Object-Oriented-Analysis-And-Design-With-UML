...
<form action="webapi/webservice/addUser" method="post">
			...
			<div class="a-section " style= " width: 320px; margin: auto; padding: 14px 18px!important; padding-top: 14px; padding-right: 18px; padding-bottom: 14px; padding-left: 18px; width: 350px;">
				<div class="a-section a-spacing a-text-center" style= "margin: auto; width: 320px;">
					<div class="a-section spacing-medium a-text-center">
						<a class="link-nav-icon" tabindex= "-1" href= "http://localhost:8080/akshay/amazonhomepage.jsp">
  ...
  vertical-align: top;" ></span>
					...
					<div class= "a-section auth-pagelet-container">
						<form id= "ap_register_form" name= "register" method= "post" style="display: block; margin-top: 0em" class="ap_ango_default auth-validate-form-moa auth-real-time-validation fwcim-form">
							...
							<div class="a-box-inner">
								...
								<label for= "emailid" class="a-form-label">Email Address(Optional)</label>
    ...
    vertical-align: middle;">
									...
									<input id="upload image" tabindex="5" class="a-button-input"  aria-labelledby="continue-announce" onclick="window.location.href='http://localhost:8080/akshay/uploadimage.html'"><span id="continue-announce" class="a-button-text" aria-hidden="true">Upload Image </span>
								</span>
									</span>
									...
									<div class="a-row">
										...
										<a class="link" href="http://localhost:8080/akshay/amazonlogin.jsp">Sign in</a>
									</div>
							</div>
							</div>		
						</form>
